        ...
        <div class="success-page__header">
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    <span>$name</span>, merci pour votre commande!
                </h2>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text" style="text-align: center">Merci, informations enregistrées.</h3>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    ...
                    <p class="success-page__message_success">
                        ...
                        <br>
                        Votre colis est prêt à l’expédition. Assurez-vous d’avoir saisi un numéro de téléphone correct et prenez l'appel de notre chargé de clientèle pour confirmer les détails.
                    </p>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text">Veuillez vérifier vos coordonnées:</h3>
                <div class="list-info">
                    <ul class="list-info__list">
                        <li class="list-info__item">
                            <span class="list-info__text">Téléphone: </span>
                            $phone
                        </li>
                    </ul>
                </div>
                <p class="success-page__message_fail">
                    <a class="success-page__message_fail__link" href="javascript:history.back()">
                        En cas d’erreur, revenez en arrière et remplissez le formulaire à nouveau.
                    </a>
                </p>
                <h3 class="success-page__text" id="lowerH">
                    Indiquez votre adresse pour accélérer la livraison:
                </h3>
                <div class="form">
                    <form action="" class="success-page__form" name="update_form" id="details" method="post">
                        <div class="success-page__form__container">
                            ...
                            <div class="success-page__form__button" onclick="SubmitForm()"> Envoyer </div>
                        </div>
                    </form>
                </div>
            </div>
...
function SubmitForm() {
    ...
    emptyFieldsMsg = "<span style='color: red'>E-mail et/ou adresse!</span>" +
        "<br><br>S'il vous plaît entrer les informations requises.",
